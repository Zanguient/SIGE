...
<html lang="en">
	...
	<body>
		...
		$lista = $control->obtenerbovinosPropietario(1);
		?>
		<?php
		if($lista){
		?>
			...
			<?php
				foreach ($lista as $bovino) {
					...
					echo "<tr>";
								...
								echo 	"<td>".$bovino->getNumeroMadre()."</td>";						echo 	"<td style=\"text-align:center;\"><button class=\"btn btn-success\" type=\"button\" ><span class='glyphicon glyphicon-pencil'></span> Modificar</button></td>";
								echo 	"<td style=\"text-align:center;\"><button class=\"btn btn-success\" type=\"button\" ><span class='glyphicon glyphicon-pencil'></span> Eliminar</button></td>";
					echo "</tr>";
			} 
			?>
			</tbody>
